...
test("The stone marker is initialized with (100, 100) as coordinates", () => {
  expect(new StoneMarker().x).toBe(83.75);
  expect(new StoneMarker().y).toBe(131.75);
...
test("Moving to the right changes the initial coordinates to be (120, 100)", () => {
  ...
  expect(stoneMarker.x).toBe(83.75);
  expect(stoneMarker.y).toBe(131.75);
  expect(movedStoneMarker.x).toBe(107.75);
  expect(movedStoneMarker.y).toBe(131.75);
});
...
test("Moving downwards changes the initial coordinates to be (100, 120)", () => {
  ...
  expect(stoneMarker.x).toBe(83.75);
  expect(stoneMarker.y).toBe(131.75);
  expect(movedStoneMarker.x).toBe(83.75);
  expect(movedStoneMarker.y).toBe(155.75);
});
...
test("Moving upwards changes the initial coordinates to be (100, 80)", () => {
  ...
  expect(stoneMarker.y).toBe(131.75);
  expect(movedStoneMarker.x).toBe(83.75);
  expect(movedStoneMarker.y).toBe(107.75);
});
...
test("Changing the ratio changes the proportions and position of the stone marker", () => {
  ...
  expect(changedStoneMarker.x).toBe(167.5);
  expect(changedStoneMarker.y).toBe(263.5);
